...
$pageTitle = 'New Program — DiaFitus admin';
  ...
  <main class="main" id="pb-main">
    <header class="topbar">
      <div class="crumb">
        ...
        <b id="pb-crumb"><a href="/admin/programs" style="color:var(--muted);font-weight:400">Programs</a> › New from PDF</b>
      </div>
    ...
    <div class="view" id="stage-done-php">
      <div class="pb-done-card">
        ...
        <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
          ...
          <a href="/admin/programs_new" class="btn">Upload another →</a>
        </div>
      </div>
    </div>
    <?php return; endif; ?>
    ...
    <div class="view pb-stage" id="stage-review">
      ...
      <!-- Real upload form -->
      <form method="post" enctype="multipart/form-data" id="pb-real-form" action="/admin/programs_new">
        <?= csrf_input() ?>
