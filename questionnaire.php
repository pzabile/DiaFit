  ...
  <main class="quiz-main" id="quizMain">
    ...
    <section class="step" data-step="8" data-key="side_effects" data-type="multi">
      ...
      <div class="options multi">
        ...
        <button class="option" data-value="neuropathy"><span>Nerve pain / numbness</span></button>
        <button class="option" data-value="vision"><span>Vision issues</span></button>
        <button class="option" data-value="slow_healing"><span>Slow wound healing</span></button>
        <button class="option" data-value="frequent_thirst"><span>Frequent thirst / urination</span></button>
        <button class="option" data-value="weight_gain"><span>Unwanted weight gain</span></button>
        <button class="option" data-value="hypos"><span>Frequent hypoglycemia</span></button>
